...
public class ConvertToRawIndexTaskGenerator extends BasePinotTaskGenerator {
  ...
  @Override
  public boolean isScheduleSegment(TableConfig tableConfig, OfflineSegmentZKMetadata offlineSegmentZKMetadata) {
